...
<body>
    <div id="form-container" class="container vh-100 d-flex justify-content-center align-items-md-center">
        <form action="/login" method="post" class="card d-flex flex-column justify-content-md-center justify-content-start text-center px-5 py-5 rounded rounded-4" style="width: 475px;">
            <div class="d-flex">
